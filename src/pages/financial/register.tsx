...
function Financial_Registration() {
      ...
      <div className="main-content app-content">
        <div className="container-fluid">
          ...
          <Breadcrumb
              ...
              links={[
                { text: "Financial", link: "/financials"},
              ]}
              active="Register Financial Record"
          />
                ...
                <div className="box-body p-5">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                          ["Financial ID", "financialId", "bi bi-tag"],
                          ["Account Name", "accountName", "bi bi-person"],
                          ["Account Number", "accountNumber", "bi bi-credit-card"],
                          ["Bank Name", "bankName", "bi bi-bank"],
                          ["Transaction ID", "transactionId", "bi bi-receipt"],
                          ["Transaction Date", "transactionDate", "bi bi-calendar-date"],
                          ["Transaction Type", "transactionType", "bi bi-exchange"],
                          ["Amount", "amount", "bi bi-currency-dollar"],
                          ["Balance", "balance", "bi bi-piggy-bank"],
                          ["Currency", "currency", "bi bi-cash"],
                          ["Payment Method", "paymentMethod", "bi bi-credit-card"],
                          ["Payment Status", "paymentStatus", "bi bi-cash-stack"],
                          ["Invoice Number", "invoiceNumber", "bi bi-file-earmark-text"],
                          ["Tax", "tax", "bi bi-receipt-cutoff"],
                          ["Discount", "discount", "bi bi-percent"],
                          ["Total Amount", "totalAmount", "bi bi-calculator"],
                          ["Financial Manager", "financialManager", "bi bi-person-badge"],
                    ...
                    <div className="mt-4">
                      <label className="block font-medium mb-1" htmlFor="biography">Financial Feedback/Rating</label>
...
export default Financial_Registration;