                ...
                <div className="box-body p-5">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                          ["Sales ID", "salesId", "bi bi-tag"],
                          ["Customer Name", "customerName", "bi bi-person"],
                          ["Product ID", "productId", "bi bi-box"],
                          ["Product Name", "productName", "bi bi-basket"],
                          ["Quantity", "quantity", "bi bi-list-ol"],
                          ["Unit Price", "unitPrice", "bi bi-currency-dollar"],
                          ["Total Price", "totalPrice", "bi bi-receipt"],
                          ["Order Date", "orderDate", "bi bi-calendar-date"],
                          ["Delivery Date", "deliveryDate", "bi bi-truck"],
                          ...
                          ["Sales Representative", "salesRep", "bi bi-person-badge"],
                          ["Discount", "discount", "bi bi-percent"],
                          ["Tax", "tax", "bi bi-receipt-cutoff"],
                          ["Grand Total", "grandTotal", "bi bi-calculator"],
                    ...
                    <div className="mt-4">
                      <label className="block font-medium mb-1" htmlFor="biography">Customer Feedback/Rating</label>
...
export default Sales_Registration;